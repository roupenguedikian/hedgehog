#!/usr/bin/env python3
"""
Hedgehog full portfolio query — runs all 6 venue queries in parallel.
Usage: python3 scripts/hedgehog_query.py [subcommand]
       subcommand is passed through to each venue script (default: all)
"""
import asyncio
import os
import subprocess
...
async def main():
    ...
    print("=" * 80)
    print("  HEDGEHOG — Full Portfolio Query (all 6 venues)")
    print("=" * 80)
